...
- `grid/` - bilder som används av pixel-gridden på startsidan.
- `assets/` - gemensamma assets som inte är grid-bilder.
- `portfolio/` - projektsidor som grid-rutorna länkar till.

## Grid-bilder

Grid-bilder för startsidan ska ligga i `grid/`. I `js/main.js` anges bara filnamnet i `imageName`, och koden bygger hela sökvägen från `GRID_IMAGE_DIR`.
